...
export default function Galeria() {
    ...
    return (
        <div className={`${style.gallery} w-2/1 1xl:w-2/3  xl:px-20 my-20 mx-auto grid grid-cols-2 1md:grid-cols-4 justify-items-center gap-4 sm:gap-x-4 px-2 sm:gap-y-5`} >
            {
            ...
            <div className={`${status ? 'opacity-100 z-40' : 'opacity-0 -z-50'} select-none fixed top-0 h-screen w-full duration-100`} >
                ...
                <div className=' h-full flex items-center justify-center duration-200' >
                    <img src={fullImageView.src} alt={fullImageView.id} className={`${idImage ? 'opacity-100' : 'opacity-30'} z-40  md:w-2/3 duration-200`} />
                </div>
